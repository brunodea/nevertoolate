...
// from: https://stackoverflow.com/questions/39825125/android-recyclerview-cursorloader-contentprovider-load-more
public abstract class CursorRecyclerViewAdapter<VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH> {
    ...
    public CursorRecyclerViewAdapter(Context context, Cursor cursor) {
        ...
        mRowIdColumn = mDataValid ? 0 : - 1;//mCursor.getColumnIndex("_id") : -1;
    ...
    public Cursor swapCursor(Cursor newCursor) {
        ...
        if (mCursor != null) {
            ...
            mRowIdColumn = 0;//newCursor.getColumnIndexOrThrow("_id");
            mDataValid = true;
